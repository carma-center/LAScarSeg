...
int main(int argc, char** argv)
{
  ...
  mask = readImage<MaskImageType>(endoImageFileName.c_str());
  ...
  writeImage<segmenter_t::MaskImageType>(resampleWall, segmentedImageFileName.c_str());
